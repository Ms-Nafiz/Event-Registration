...
// ১. বাংলা ফন্ট রেজিস্টার (Unicode Font)
Font.register({
    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.eventSubInfo}>
            তারিখ: {EVENT_DETAILS.date} | সময়: {EVENT_DETAILS.time}
          </Text>
        ...
        <View style={styles.body}>
          ...
          <View style={styles.leftCol}>
            ...
            <Text style={[styles.qrText, { color: "red", marginTop: 2 }]}>
              স্ক্যান করুন
            </Text>
          </View>
        ...
        <View style={styles.footerSection}>
          ...
          <Text style={styles.termText}>
            ২. একটি কার্ড দিয়ে উল্লিখিত সংখ্যক ব্যক্তিই কেবল প্রবেশ করতে পারবেন।
          </Text>
          <Text style={styles.termText}>
            ৩. খাবার সংগ্রহের জন্য নিচের কুপনটি সংরক্ষণ করুন।
          </Text>
          <Text style={styles.termText}>
            ৪. কর্তৃপক্ষের সিদ্ধান্তই চূড়ান্ত।
          </Text>

          {/* সোশ্যাল লিংক */}
          <View style={styles.contactRow}>
            <Text style={styles.contactText}>
              আয়োজক: {EVENT_DETAILS.organizer}
            </Text>
            <Link
              src={`https://${EVENT_DETAILS.fbPage}`}
              style={styles.contactText}
            >
              FB: {EVENT_DETAILS.fbPage}
            </Link>
            <Text style={styles.contactText}>
              WhatsApp: {EVENT_DETAILS.whatsapp}
            </Text>
          </View>
        </View>
      </View>
      ...
      <View style={styles.dividerContainer}>
        ...
        <Text style={styles.scissorText}>
          ✂️ এখান থেকে কেটে খাবার কাউন্টারে জমা দিন ✂️
        </Text>
      </View>
          ...
          <View style={{ width: "100%" }}>
            ...
            >
              <Text style={{ fontSize: 10 }}>
                আইডি: <Text style={styles.redHighlight}>{data.id}</Text>
              </Text>
              <Text style={{ fontSize: 10 }}>নাম: {data.name + " "}</Text>
              <Text style={{ fontSize: 10 }}>
                গ্রুপ: {data.groupName + " "}
              </Text>
            </View>
            ...
            >
              <Text style={{ fontSize: 14, fontWeight: "bold" }}>
                মোট প্যাকেট: {data.totalMembers} টি
              </Text>
            </View>
          </View>
        </View>
